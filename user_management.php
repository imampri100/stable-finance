...
<div class="main-content">
    ...
    <div class="stats-container">
        ...
        <div class="stat-card">
            ...
            <div class="stat-value"><?php echo number_format($total_active_user) ?></div>
        </div>

        <div class="stat-card">
            <div class="stat-title">Total Inactive User</div>
            <div class="stat-value"><?php echo number_format($total_inactive_user) ?></div>
        </div>
    </div>
    ...
    <div class="table-container">
        ...
        ?>
            <div class='table-row'>
                ...
                <div class='table-cell'><?php echo $row['email'] ?></div>
                <div class='table-cell'><?php echo $row['role'] ?></div>
                <div class='table-cell'><?php echo $is_active ?></div>
                <div class='table-cell'>
                    <?php if ($row['id'] != $user['id']):?>
                    <div class='action-icons'>
                        <div class='action-icon'>
                            <a href="user_management_view.php?user_id=<?php echo $row['id'] ?>">
                        ...
                        <div class='action-icon'>
                            <a href="user_management_edit.php?user_id=<?php echo $row['id'] ?>">
                        ...
                        <div class='action-icon'>
                            <a href="user_management_remove.php?user_id=<?php echo $row['id'] ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap="round" stroke-linejoin="round">
                                    <path d='M3 6h18'></path>
