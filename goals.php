...
<body>
    ...
    <div class="main-content">
        <div class="header">
            <div class="page-title">Saving Goals</div>
            <div class="user-info">
        ...
        <div class="stats-container">
            ...
            <div class="stat-card">
                <div class="stat-title">Save More</div>
        ...
        <div class="stats-container">
            <div class="stat-card">
                <div class="goals-card-title ">Tuition Fee</div>
            ...
            <div class="stat-card">
                <div class="goals-card-title ">Beli Kamera</div>
                <div class="goals-card-detail">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="margin-right:8px; vertical-align:middle;">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                        <line x1="16" y1="2" x2="16" y2="6"></line>
            ...
            <div class="stat-card">
                <div class="goals-card-title ">Mobil</div>
                <div class="goals-card-detail">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="margin-right:8px; vertical-align:middle;">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                        <line x1="16" y1="2" x2="16" y2="6"></line>
            ...
            <div class="stat-card">
                <div class="goals-card-title ">Sepeda Listrik</div>
                <div class="goals-card-detail">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="margin-right:8px; vertical-align:middle;">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                        <line x1="16" y1="2" x2="16" y2="6"></line>
            ...
            <div class="stat-card">
                <div class="goals-card-title ">HP Baru</div>
                <div class="goals-card-detail">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="margin-right:8px; vertical-align:middle;">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                        <line x1="16" y1="2" x2="16" y2="6"></line>
            ...
            <div class="stat-card">
                <div class="goals-card-title ">TV</div>
                <div class="goals-card-detail">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="margin-right:8px; vertical-align:middle;">
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                        <line x1="16" y1="2" x2="16" y2="6"></line>
