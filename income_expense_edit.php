...
if (isset($_POST['submit'])) {
    ...
    if (!$transaction) {
        echo "<script>
            alert('Failed update transaction: message: ' . $transaction->error)
            window.history.back();
        </script>";
        exit();
    }
        ...
        <div class="form-grid">
                ...
                <label class="form-label" for="type">
                    ...
                    <select class="type" id="type" name="type" required>
                        ...
                        <?php foreach ($types as $option_key => $option_value): ?>
                            <option value="<?php echo $option_value ?>" <?php echo ($option_value == $transaction['transaction_type']) ? 'selected': ''; ?>><?php echo $option_value ?></option>
                        <?php endforeach; ?>
                    </select>
                </label>
            </div>
            ...
            <div class="form-group">
                <label class="form-label" for="description">
                    Description
                    <input type="text" placeholder="Description" name="description" value="<?php echo $transaction['description'] ?>" required>
                </label>
            </div>
            ...
            <div class="form-group">
                <label class="form-label" for="nominal">
                    Nominal (Rupiah)
                    <input type="number" placeholder="Nominal" name="nominal" value="<?php echo $transaction['amount'] ?>" required>
                </label>
            </div>
            ...
            <div class="form-group">
                <label class="form-label" for="date">
                    Date
                    <input type="date" placeholder="Date" name="date" value="<?php echo $transaction['transaction_date'] ?>"  required>
                </label>
            </div>
